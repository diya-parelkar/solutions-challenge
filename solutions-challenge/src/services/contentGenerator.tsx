      ...
      try {
        ...
        const contentPrompt = `
            ...
            **Instructions:**
            ...
            5. ${imageRequired ? "Describe the type of image that should be included, specifying key elements and details to be visually represented." : ""}
            ...
            12. **Return only the HTML content**, without any extra text or explanations.
